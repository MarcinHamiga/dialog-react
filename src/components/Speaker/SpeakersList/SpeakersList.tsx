...
const SpeakersList = ({previous, canHide, noAddButton, paginate=false, limit=11}: SpeakersListProps) => {
    ...
    return (
        <section className={`flex flex-col flex-grow justify-between w-full p-6 ${(speakersHidden) ? "max-h-[82px] transition-all" : `h-full ${canHide ? `max-h-[50%]` : ""}`} overflow-y-hidden bg-gray-700`}>
            <div className="max-w-full w-full">
                ...
                {isLoading ? (
                    ...
                    <div
                        ...
                        `}
                    >
                        {!noAddButton ? (<NewElementCard to={'/speaker/new'} previous={previous}/>) : ("")}
